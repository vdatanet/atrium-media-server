...
* **A sidecar's encoding is detected with three steps and no statistics, and that is a decision
  ...
  a new runtime dependency, which is not an implementation detail and is **the user's to take**.
