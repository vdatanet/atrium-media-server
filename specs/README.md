...
| [015](015-user-administration/) | User administration | **Draft** 2026-09-16 — fourteen questions, four decided the same day (OQ-3 twice, as OQ-14) and **ten waiting on a reading**; the user disclosure is narrowed by withholding two properties on all three roads at once | — | — |
