...
| [010](010-conformance-harness/) | Conformance harness | **Accepted** | Draft | — |
...
destroyed with everything it wrote — and it reserves **five decisions** for their owner rather than
taking them, the first being the runtime that instance needs. Writing it against the files rather
...
script's name — and AC-6, applied literally, fails the very allowlist the spec ships. **011's spec was accepted on the same day as 008's**, at its
