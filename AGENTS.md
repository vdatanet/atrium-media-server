...
written. It reserves **four decisions** and records a fifth as taken: **D-2, out of 012** — after a
real scan `items.runtime_ticks` is `NULL` on every file-backed item, measured in this repository on
2026-09-03, and it is a scan-time defect its owning feature fixes. **[009](specs/009-playlists/) landed on 2026-09-01 across fourteen tasks**, its spec accepted at a
