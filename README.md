...
| [docs/compatibility/api-surface-v1.md](docs/compatibility/api-surface-v1.md) | The 65 endpoints in scope — v1's 59 and the first 6 of v2 — and where that number comes from |
